            ...
            <React.Fragment>
                ...
                <div className="container-fluid" style={{height: '100vh'}}>
                    <div className="row">
                        ...
                        <div className="col-5">
                            <Map markerList = {this.state.markerList} hotelMarkerList = {this.state.hotelMarkerList} count = {this.state.count} hotelCount = {this.state.hotelCount} removeAttraction = {this.removeAttraction} removeHotel = {this.removeHotel}/>
                        </div>
                    </div>
                </div>
            </React.Fragment>

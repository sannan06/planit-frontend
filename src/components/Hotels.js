            ...
            <React.Fragment>
                ...
                <div className="col-7">
                    <CardContent>
                        ...
                        <Button size="small" color="primary" className="add-item-button" onClick = {() => this.props.addHotel(48.8584,  2.2945, "Eiffel Tower")}>
                        Add to itinerary
                        </Button>
                    </CardContent>
                </div>
                ...
                <div className="col-7">
                    <CardContent>
                        ...
                        <Button size="small" color="primary" className="add-item-button" onClick = {() => this.props.addHotel(48.8672, 2.7838, "Disney Land")}>
                        Add to itinerary
                        </Button>
                ...
                <div className="col-7">
                    <CardContent>
                        ...
                        <Button size="small" color="primary" className="add-item-button" onClick = {() => this.props.addHotel(48.8606, 2.3376, "Louvre")}>
                        Add to itinerary
                        </Button>
                    </CardContent>
                </div>
